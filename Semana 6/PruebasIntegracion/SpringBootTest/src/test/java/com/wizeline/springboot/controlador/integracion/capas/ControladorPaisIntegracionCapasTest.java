...
package com.wizeline.springboot.controlador.integracion.capas;
 ...
 */
// Tipo especial de tests para web, incluyendo controladores, filtros y Spring Security.
// Excluye: otros beans de Spring, @Service, @Reposity, @Entity, @Component
// Esta es una copia de ControladorPaisIntegracionTest, pero solo levantando la capa web
@WebMvcTest(ControladorPais.class)
public class ControladorPaisIntegracionCapasTest {
